...
public class ExprObjectOfPacket extends SimpleExpression<Object> {
    ...
    public static void registerConverters() {
        ...
        registerSingleConverter("object", new PacketInfoConverter<Object>(Object.class) {
            @Override
            public Object get(PacketContainer packet, int index) {
                return packet.getModifier().readSafely(index);
            }

            @Override
            public void set(PacketContainer packet, int index, Object value) {
        ...
        registerSingleConverter("location", new PacketInfoConverter<Location>(Location.class) {
            @Override
            public Location get(PacketContainer packet, int index) {
            ...
            @Override
            public void set(PacketContainer packet, int index, Location value) {
                StructureModifier<BlockPosition> structureModifier = packet.getBlockPositionModifier();
        ...
        registerSingleConverter("uuid", new PacketInfoConverter<String>(String.class) {
            @Override
            public String get(PacketContainer packet, int index) {
                return Optional.ofNullable(packet.getUUIDs().readSafely(index)).map(UUID::toString).orElse(null);
            }

            @Override
            public void set(PacketContainer packet, int index, String value) {
        ...
        registerSingleConverter("material", new PacketInfoConverter<ItemStack>(ItemStack.class) {
            @Override
            public ItemStack get(PacketContainer packet, int index) {
                Material material = packet.getBlocks().readSafely(index);
                return material == null ? null : new ItemStack(material);
            }

            @Override
            public void set(PacketContainer packet, int index, ItemStack value) {
        ...
        registerPluralConverter("collection", new PacketInfoConverter<Object[]>(Object[].class) {
            @Override
            public Object[] get(PacketContainer packet, int index) {
    ...
    private static PacketInfoConverter createConverter(Method method) {
        ...
        try {
            ...
            if (!tempStructureModifier.getFieldType().isArray()) {
                return new PacketInfoConverter(Object.class) {
                    @Override
                    public Object get(PacketContainer packet, int index) {
                        try {
