 ...
 */
public class ExprEntityFieldOfPacket extends SimpleExpression<Entity> {
    ...
    public String toString(Event event, boolean b) {
        return worldExpression + " entity" + (isSingle ? "" : " array") + " field " + index + " of " + packetContainerExpression;
    }
