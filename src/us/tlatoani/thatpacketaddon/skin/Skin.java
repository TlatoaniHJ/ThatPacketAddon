...
public class Skin {
    ...
    //Tablisknu Skin Conversion

    private static Boolean useTablisknuSkin = null;

    public static boolean isTablisknuSkinUsed() {
        if (useTablisknuSkin == null) {
            useTablisknuSkin = Reflection.classExists("us.tlatoani.tablisknu.skin.Skin");
        }
        return useTablisknuSkin;
    }

    public static Object toSkriptSkin(Skin skin) {
        if (isTablisknuSkinUsed() && skin != null) {
            return SkinConverter.toTablisknuSkin(skin);
        } else {
            return skin;
        }
    }

    public static Skin fromSkriptSkin(Object skin) {
        if (isTablisknuSkinUsed() && skin != null) {
            return SkinConverter.fromTablisknuSkin(skin);
        } else {
            return (Skin) skin;
        }
    }
